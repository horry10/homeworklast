...
<form name="mem_form" method="post" action="update/회원update.php">
...
<tr>
    <td align="right"> 업데이트 할 회원 아이디 번호 </td>
...
<tr>
	...
	<td> <input type="text" size="15" maxlength="12" name="age" value="31"></td>
</tr>
<tr>
...
<form name="mem_form" method="post" action="update/관리자update.php">
    <input type="hidden" name="title" value="회원가입 양식">

    <table border="1" width="640" cellspacing="1" cellpadiing="4">
    <caption>관리자 테이블</caption>


<tr>
    <td align="right"> 업데이트 할 관리자 이름 번호 </td>
    <td><input type="text" size="15" maxlength="12" name="realid" value="1"></td>
</tr>
<tr>
...
<tr>
    <td align="right"> 관리자 아이디 : </td>
	<td> <input type="text" size="15" maxlength="12" name="id" value="admin"></td>
</tr>
<tr>
    <td align="right"> 비밀번호 : </td>
    <td><input type="password" size="15" maxlength="10" name="passwd" value="ZADMIN"> </td>
</tr>
...
<form name="mem_form" method="post" action="update/화장품update.php">
    ...
    <table border="1" width="640" cellspacing="1" cellpadding="4">
        ...
        <tr>
    <td align="right"> 업데이트 할 화장품 번호 </td>
    <td><input type="text" size="15" maxlength="12" name="realid" value="1"></td>
</tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" size="15" maxlength="10" name="price" value="29.11"> </td>
        </tr>
        <tr>
...
<form name="mem_form" method="post" action="update/댓글update.php">
    <input type="hidden" name="title" value="댓글 등록 양식">

    <table border="1" width="640" cellspacing="1" cellpadding="4">
        <caption>댓글 테이블</caption>
        <tr>
    <td align="right"> 업데이트 할 댓글 번호 </td>
    <td><input type="text" size="15" maxlength="12" name="realid" value="1"></td>
</tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" size="15" maxlength="10" name="comment" value="이 제품 정말 최고에요!"> </td>
        </tr>
        <tr>
...
<form name="mem_form" method="post" action="update/구독update.php">
    ...
    <table border="1" width="640" cellspacing="1" cellpadding="4">
        ...
        <tr>
            ...
            <td><input type="text" size="15" maxlength="10" name="subscription_status" value="0"> </td>
        </tr>
        <tr>
